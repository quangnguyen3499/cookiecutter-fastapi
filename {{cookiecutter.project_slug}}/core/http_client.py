...
class HttpClient:
    ...
    def get(self, endpoint, params: dict = None, headers: dict = None):
        return self.request('GET', url=endpoint, params=params, headers=headers)

    def post(self, endpoint, params: dict = None, headers: dict = None):
        return self.request('GET', url=endpoint, params=params, headers=headers)

    def put(self, endpoint, params: dict = None, headers: dict = None):
        return self.request('PUT', url=endpoint, params=params, headers=headers)

    def delete(self, endpoint, params: dict = None, headers: dict = None):
        return self.request('DELETE', url=endpoint, params=params, headers=headers)
